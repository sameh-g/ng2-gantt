...
export class AppComponent {
    ...
    drawGantt(year) {
        ...
        this.gantt3 = new Gantt("01/01/2016", "11/05/2016", "03/01/2016", "", "", 50, 3, true, year);
        ...
        this.gantt6 = new Gantt("12/30/2016", "01/30/2017", "", "", "", 5, 3, false, year);
        this.gantt7 = new Gantt("03/20/2016", "12/05/2016", "", "", "", 10, 3, false, year);
        this.gantt8 = new Gantt("01/01/2016", "12/05/2016", "01/20/2016", "12/15/2016", "", 100, 2, true, year);
        this.gantt9 = new Gantt("01/30/2016", "12/15/2016", "01/01/2016", "11/15/2016", "", 100, 2, false, year);
        this.gantt10 = new Gantt("01/30/2016", "10/15/2016", "01/01/2016", "", "12/01/2016", 50, 1, true, year);
        this.gantt11 = new Gantt("01/01/2016", "12/22/2016", "01/01/2016", "", "10/01/2016", 50, 2, true, year);
    }
    previousYear() {
        this.year--;
        this.drawGantt(this.year);
